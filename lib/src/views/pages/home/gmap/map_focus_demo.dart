...
import 'package:seatrack_ui/src/core/controllers/demo_controller.dart';
...
import 'package:seatrack_ui/src/models/mock/data_image.dart';
                  ...
                  Card(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        ListTileItemWidget(Icons.album, 'Loại thiết bị',
                            device.deviceInfo!.version),
                        ListTileItemWidget(
                            Icons.album, 'IMEI', device.deviceInfo!.imei),
                        ListTileItemWidget(Icons.album, 'SIM',
                            device.deviceInfo!.simNumberInf),
                      ],
                    ),
                  ),
                  Card(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ListTileItemWidget(Icons.album, 'Hết hạn',
                            timeToString(device.deviceInfo!.dateExpired)),
                        ListTileItemWidget(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              alignment: Alignment.centerLeft,
              child: Text(_datas[index].addr, style: TextStyle(fontSize: 12.0)),
            ),
          ],
        ));
  }
        ...
        child: Column(
          children: [
            ...
            Container(
              padding: EdgeInsets.fromLTRB(8, 0, 8, 8),
              alignment: Alignment.centerLeft,
              child: Text(supportingText2, style: TextStyle(fontSize: 12.0)),
            ),
          ],
        ));
  }
                        ...
                        child: TextButton(
                            onPressed: () {
                              DatePicker.showDateTimePicker(context,
                                  currentTime: reportController.start != null
                            ...
                            child: Text(
                              '${reportController.start != null ? timeToString(reportController.start!) : timeToString(DateTime.now())}',
                            )),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: TextButton(
                            onPressed: () {
                              DatePicker.showDateTimePicker(context,
                                  currentTime: reportController.end != null
                            ...
                            child: Text(
                              '${reportController.end != null ? timeToString(reportController.end!) : timeToString(DateTime.now())}',
                            )),
                      ),
                    ],
                  ),
