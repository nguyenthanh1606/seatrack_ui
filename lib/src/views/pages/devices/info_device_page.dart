...
class DeviceInfoPage extends StatelessWidget {
  const DeviceInfoPage({Key? key, required this.deviceId}) : super(key: key);
  final int deviceId;
  @override
  Widget build(BuildContext context) {
    return GetBuilder<DeviceInfoController>(
      // int: () {Get.find<DeviceInfoController>().getDvInfo(deviceId)},
              ...
              Card(
                child: Column(
                  ...
                  children: const <Widget>[
                    ...
                    ListTileItemWidget(
                        Icons.album, 'Biển số xe', '51F09-12111'),
                    ListTileItemWidget(Icons.album, 'Tên lái xe', ''),
                    ListTileItemWidget(
                        Icons.album, 'Số liên lạc', '0123456789'),
                  ],
                ),
              ),
            ],
